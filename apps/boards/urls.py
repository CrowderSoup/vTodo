...
urlpatterns = [
    ...
    path("statuses/reorder/", views.StatusReorderView.as_view(), name="status-reorder"),
    path("lanes/<str:lane_key>/hide/", views.LaneHideView.as_view(), name="lane-hide"),
    path("lanes/<str:lane_key>/archive/", views.LaneArchiveView.as_view(), name="lane-archive"),
